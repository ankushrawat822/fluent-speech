...
const Partner = () => {
  ...
  return (
    <>
      <div className='px-3 flex flex-col items-center justify-center gap-2 sm:px-5 md:px-10 lg:px-20 xl:px-44 mt-10'>
      ...
      {/* clients logos  */}
      <div className='flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 mt-10 sm:mt-0'>
      ...
      <div className='hidden lg:flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 mt-10 sm:mt-[-100px]'>
        <img src={homeClient4} alt="" />
        <img src={homeClient3} alt="" />
...

      {
        ShowMoreClientLogo &&
        // {/* clients logo 2nd div */}
        <div className=' flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 mt-10 sm:mt-[-100px]'>
          <img src={homeClient3} alt="" />
          <img src={homeClient1} alt="" />
      ...
      <div onClick={() => setShowMoreClientLogo(prev => !prev)} className='cursor-pointer flex items-center justify-center flex-col gap-0 '>
      ...
      {/* text p */}
      <div className='flex items-center justify-center px-3 sm:px-5 md:px-10 lg:px-20 xl:px-44 mt-10 mb-24'>
      ...
      {/* Our Recognitions & Awards */}
       <div className=' flex flex-col sm:flex-row flex-wrap items-start justify-center gap-9 mt-16'>
