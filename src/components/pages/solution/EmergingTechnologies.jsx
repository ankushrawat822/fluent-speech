...
const EmergingTechnologies = () => {
    return (
        <>
            ...
            {/* blue bg  div  */}
            <div className='emerg-tech-blue-div px-3 py-8 my-10 md:px-20 lg:px-28 xl:px-36 mb-20'>
            ...
            <div className='flex flex-col items-center justify-center gap-9'>
                {/* box 1 */}
                <div className='emerging-tech-white-div-drop-shadow flex flex-col items-start justify-start gap-2 text-start p-5 w-full sm:w-[80%] lg:w-[70%] rounded-[10px]'>
                 ...
                 {/* box 2 */}
                 <div className='emerging-tech-white-div-drop-shadow bg-[#023267] flex flex-col items-start justify-star gap-2 text-start p-5 w-full sm:w-[80%] lg:w-[70%] rounded-[10px] text-white'>
...
Unlock the value of unstructured to structured data. Agile Global can help analyze and implement AI/ML functionality from Integrated Analytics, Performance Dashboards to complex AI/ML applications. </p>
                 ...
                 {/* box 3 */}
                 <div className='emerging-tech-white-div-drop-shadow flex flex-col items-start justify-star gap-2 text-start p-5 w-full sm:w-[80%] lg:w-[70%] rounded-[10px]'>
