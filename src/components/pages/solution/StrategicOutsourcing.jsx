...
const StrategicOutsourcing = () => {
  return (
    <>
      ...
      {/* below white div */}
      <div className='startegic-drop-shadow flex items-center justify-center w-full py-10 px-3 md:px-6 lg:px-10 xl:px-44'>
      ...
      <div  className='text-[16px] sm:text-[18px] text-center md:text-start leading-[30px]  flex flex-col items-center justify-center gap-5 md:gap-10 md:flex-row my-5  py-10 px-3 md:px-6 lg:px-10 xl:px-44'>
       ...
       {/* below blue div */}
       <div className='bg-[#023267] text-white flex items-center justify-center w-full py-10 px-3 md:px-6 lg:px-10 xl:px-44'>
